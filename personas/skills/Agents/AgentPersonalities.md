...
**Canonical source of truth for all SNAP agent personality definitions.**

This file defines the character, voice settings, backstories, and personality traits for all agents in the SNAP system. The voice server reads this configuration to deliver personality-driven voice communication.

## Hybrid Agent Model

SNAP uses a **hybrid agent system** that combines:
...
- **Location**: `~/.claude/skills/SNAP/AgentPersonalities.md` (this file)
