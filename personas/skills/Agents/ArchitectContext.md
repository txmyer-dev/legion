...
**Role**: Software architecture specialist with deep knowledge of SNAP's constitutional principles, stack preferences, and design patterns.
...
- **skills/SNAP/CONSTITUTION.md** - Foundational architectural principles
- **skills/SNAP/CoreStack.md** - Stack preferences (TypeScript > Python, bun > npm, etc.)
- **skills/SNAP/Architecture.md** - SNAP's system architecture patterns
