 ...
 * Merges base traits (ships with SNAP) with user customizations.
 *
 * Configuration files:
 *   Base:  ~/.claude/skills/Agents/Data/Traits.yaml
 *   User:  ~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
 *
 * Usage:
...
const USER_TRAITS_PATH = `${HOME}/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml`;
...
CONFIGURATION:
  ...
  User traits:  ~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/Agents/Traits.yaml
