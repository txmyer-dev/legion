---
name: Art
description: Complete visual content system. USE WHEN user wants to create visual content, illustrations, diagrams, OR mentions art, header images, visualizations, mermaid, flowchart, technical diagram, infographic, SNAP icon, pack icon, or SNAP pack icon.
---
...
`~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/Art/`
...
Route to the appropriate workflow based on the request.
  ...
  - SNAP pack icon → `Workflows/CreatePAIPackIcon.md`
...
**Load from:** `~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md`
...
Check `~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/Art/PREFERENCES.md` for:
...
→ After approval, copies to ${PROJECTS_DIR}/SNAP/Packs/icons/
```
