...
`~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/CreateCLI/`
...
## 🏗️ INTEGRATION WITH SNAP

### Technology Stack Alignment

Generated CLIs follow SNAP standards:
...
- `${PROJECTS_DIR}/SNAP/Examples/clis/` - Example CLIs (PUBLIC repo)
...
### 5. Integration
- ✅ Follows SNAP tech stack (Bun, TypeScript)
- ✅ CLI-First Architecture principles
- ✅ Deterministic output (JSON)
