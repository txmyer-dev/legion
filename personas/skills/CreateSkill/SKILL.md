...
`~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/CreateSkill/`
...
**Before creating ANY skill, READ:** `~/.claude/skills/SNAP/SkillSystem.md`
...
**See:** `~/.claude/skills/SNAP/SkillSystem.md` (Flat Folder Structure section)
...
**See:** `~/.claude/skills/SNAP/SkillSystem.md` (Dynamic Loading Pattern section)
