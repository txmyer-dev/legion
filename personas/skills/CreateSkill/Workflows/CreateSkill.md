...
1. Read the skill system documentation: `~/.claude/skills/SNAP/SkillSystem.md`
...
**Reference:** `~/.claude/skills/SNAP/CliFirstArchitecture.md` (Workflow-to-Tool Integration section)
