...
`~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/ExtractWisdom/`
...
| **Basic** | 3 | 5 | References & Rabbit Holes | Solid overview without the deep cuts. |
| **Full** | 5-12 | 3-15 | References & Rabbit Holes | The default. Complete extraction. |
| **Comprehensive** | 10-15 | 8-15 | References & Rabbit Holes + Themes & Connections | Maximum depth. Nothing left behind. |
...
**Canonical voice reference: `skills/SNAP/USER/WRITINGSTYLE.md`** — read this file for the full voice definition. The bullets should sound like {PRINCIPAL.NAME} telling a friend about it over coffee. Not compressed info nuggets. Not clever one-liners. Actual spoken observations.
...
| **Instant** | None |
| **Fast** | None |
| **Basic** | References & Rabbit Holes |
| **Full** | References & Rabbit Holes |
| **Comprehensive** | References & Rabbit Holes + Themes & Connections |
...
## Ekko's Take (MANDATORY — ALWAYS FIRST)

Every extraction MUST include `## Ekko's Take` as the first section after the title/description line — before any content sections. No exceptions. This is not optional and does not depend on depth level.

Write it as a trusted advisor giving Tony the honest verdict: what's genuinely useful, how it connects to his projects (Paperclip, ContentMate, Crowbar Crew, domain layer, SNAP), what's already in the stack, what's missing, and where the speaker oversells. Direct and opinionated. Not a summary.

**If you write the file and there is no `## Ekko's Take` as the first content section — you are not done.**
...
{Honest first-person verdict. Connect to Tony's projects and goals. What's actionable, what's hype, what's already in the stack.}
...
- [ ] **`## Ekko's Take` is present as the FIRST section after the title/description**
...
- [ ] References & Rabbit Holes included (Basic level and above)
