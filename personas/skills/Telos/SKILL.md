...
1. **Personal TELOS** - {PRINCIPAL.NAME}'s life context system (beliefs, goals, lessons, wisdom) at `~/.claude/skills/SNAP/USER/TELOS/`
...
|--------------|---------|----------|
| "my TELOS", "my goals", "my beliefs", "add to TELOS" | Personal TELOS | `~/.claude/skills/SNAP/USER/TELOS/` |
...
All files located in `~/.claude/skills/SNAP/USER/TELOS/`:
...
```bash
# View specific file
read ~/.claude/skills/SNAP/USER/TELOS/GOALS.md
read ~/.claude/skills/SNAP/USER/TELOS/BELIEFS.md

# View recent updates
read ~/.claude/skills/SNAP/USER/TELOS/updates.md
```
...
- Follow SNAP security protocols
...
1. **Dual Context** - Handles both personal and project TELOS seamlessly
   - Personal TELOS: `~/.claude/skills/SNAP/USER/TELOS/` (in CORE USER directory)
...
**Remember:** Personal TELOS files live at `~/.claude/skills/SNAP/USER/TELOS/` (in the CORE USER directory)
