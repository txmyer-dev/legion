...
TELOS is {PRINCIPAL.NAME}'s life framework stored in `~/.claude/skills/SNAP/USER/TELOS/`. It contains:
...
!`head -50 ~/.claude/skills/SNAP/USER/TELOS/updates.md`

## View Specific TELOS File
!`FILE="$1"; cat ~/.claude/skills/SNAP/USER/TELOS/"$FILE"`
...
All backups are stored in: `~/.claude/skills/SNAP/USER/TELOS/Backups/`

All changes are logged in: `~/.claude/skills/SNAP/USER/TELOS/updates.md`
